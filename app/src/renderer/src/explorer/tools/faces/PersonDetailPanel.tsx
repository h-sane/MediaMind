...
/** All media for one person, opened from their card in the People grid.
 * Reuses the same thumbnail/viewer components as the plain file browser —
 * still just the real files on disk, filtered to the ones this person is in. */
export function PersonDetailPanel({ libraryId, personId, onBack }: Props): React.JSX.Element {
